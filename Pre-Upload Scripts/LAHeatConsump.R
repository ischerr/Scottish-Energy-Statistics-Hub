...
LARenGen <- LARenGen[which(LARenGen$variable == "Total"),]
...
LAMap <-
  merge(LA, LARenGen, key.shp = "CODE", key.data = "CODE")
...
tmap_save(ScotlandMap, filename = "Pre-Upload Scripts/Maps/ScotlandLAHeatConsump.svg")
...
#Export to PDF
tmap_save(CentralMap, filename = "Pre-Upload Scripts/Maps/CentralLAHeatConsump.svg")
