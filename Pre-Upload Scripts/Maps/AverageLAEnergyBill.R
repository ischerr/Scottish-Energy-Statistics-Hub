...
#Export to PDF, to be used in Inkscape
save_tmap(ScotlandMap, filename = "Pre-Upload Scripts/Maps/ScotlandElectric.svg")
...
#Export to PDF
save_tmap(CentralMap, filename = "Pre-Upload Scripts/Maps/CentralElectric.svg")
...
#Export to PDF, to be used in Inkscape
save_tmap(ScotlandMap, filename = "Pre-Upload Scripts/Maps/ScotlandGas.svg")
...
#Export to PDF
save_tmap(CentralMap, filename = "Pre-Upload Scripts/Maps/CentralGas.svg")
