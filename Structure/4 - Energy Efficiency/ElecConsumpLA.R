...
ElecConsumptionLAOutput <- function(id) {
  ns <- NS(id)
  tagList(
    fluidRow(column(8,
...
###### Server ######
ElecConsumptionLA <- function(input, output, session) {
  # output$ElecConsumptionLAPlot <- renderDygraph({
  #   RenEn <-
  #     read.csv(
  #       "Structure/2 - Renewables/Electricity/ElecConsumptionLA.csv",
  #       header = TRUE,
  #       sep = ",",
  #       na.strings = "-"
  #     )
