...
RenEnTgtOutput <- function(id) {
  ...
  tagList(
    ...
    fluidRow(
      column(10, h3("Data - Electricity Summary", style = "color: #1A5D38;  font-weight:bold")),
    ...
    tags$hr(style = "height:3px;border:none;color:#1A5D38;background-color:#1A5D38;"),
    fluidRow(
      column(10, h3("Data - Heat Summary", style = "color: #1A5D38;  font-weight:bold")),
    ...
    tags$hr(style = "height:3px;border:none;color:#1A5D38;background-color:#1A5D38;"),
    fluidRow(
      column(10, h3("Data - Transport Summary", style = "color: #1A5D38;  font-weight:bold")),
    ...
    tags$hr(style = "height:3px;border:none;color:#1A5D38;background-color:#1A5D38;"),
    fluidRow(
      column(10, h3("Data - Total Summary", style = "color: #1A5D38;  font-weight:bold")),
