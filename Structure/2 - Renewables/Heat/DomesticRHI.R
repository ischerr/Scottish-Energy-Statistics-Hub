...
DomesticRHIOutput <- function(id) {
  ...
  tagList(
    ...
    tabsetPanel(
      ...
      tabPanel("Heat generated",
    fluidRow(
    column(10, h3("Data - Domestic RHI - heat generated by technology, April 2014 - May 2020", style = "color: #39ab2c;  font-weight:bold")),
...
DomesticRHI <- function(input, output, session) {
  ...
  output$DomesticRHISubtitle <- renderText({
    ...
    paste("Scotland, Apr 2014 - May 2020")
  })
  ...
  output$DomesticRHITable = renderDataTable({
    ...
    datatable(
      ...
      options = list(
        ...
        fixedColumns = FALSE,
        autoWidth = TRUE,
        title = "Domestic RHI heat generated and capacity by technology, Scotland, April 2014 - May 2020",
        dom = 'ltBp',
        buttons = list(
          list(extend = 'copy'),
          list(
 ...
 observeEvent(input$ToggleTable1, {
  ...
  output$DomesticRHI.png <- downloadHandler(
    ...
    content = function(file) {
      ...
      DomesticRHIChart <-
        DomesticRHIChart +
        labs(subtitle = "Scotland, Apr 2014 - May 2020") +
        ylim(
