...
DomesticRHIOutput <- function(id) {
  ...
  tagList(
    ...
    tabsetPanel(
      ...
      tabPanel("Heat generated",
    fluidRow(
    column(10, h3("Data - Domestic RHI - heat generated by technology, April 2014 - June 2019", style = "color: #39ab2c;  font-weight:bold")),
  ...
  output$DomesticRHITable = renderDataTable({
    ...
    datatable(
      ...
      options = list(
        ...
        fixedColumns = FALSE,
        autoWidth = TRUE,
        title = "Domestic RHI heat generated and number of installations receiving payment by technology, Scotland, April 2014 - June 2019",
        dom = 'ltBp',
        buttons = list(
          list(extend = 'copy'),
          list(
