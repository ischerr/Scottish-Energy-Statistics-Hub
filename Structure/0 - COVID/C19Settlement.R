...
C19SettlementOutput <- function(id) {
  ...
  tagList(
    ...
    tabsetPanel(
      tabPanel("Demand by settlement period",
    fluidRow(
    column(10, h3("Data - Electricity demand by settlement period, week commencing 31/08/20 and equivalent week in 2019.", style = "color: #5d8be1;  font-weight:bold")),
...
C19Settlement <- function(input, output, session) {
  ...
  output$C19SettlementSubtitle <- renderText({
    ...
    paste("Scotland, week commencing 31/08/20 and equivalent week in 2019")
  })
  ...
  output$C19SettlementPlot <- renderPlotly  ({
    ...
    ElecDemandHalfHourly$Date <- ymd("2020/08/31")
  ...
  output$C19SettlementTable = renderDataTable({
    ...
    DT::datatable(
      ...
      options = list(
        ...
        fixedColumns = FALSE,
        autoWidth = TRUE,
        title = "Electricity demand by settlement period, week commencing 31/08/20 and equivalent week in 2019",
        dom = 'ltBp',
        buttons = list(
          list(extend = 'copy'),
          list(
    ...
    content = function(file) {
      ...
      ElecDemandHalfHourlyChart <- ElecDemandHalfHourlyChart +
        ...
        labs(
          ...
          face = 2,
          subtitle = paste(
            "Scotland, week commencing 31/08/20 and equivalent week in 2019"
          )
        )+
